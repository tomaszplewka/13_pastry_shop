...
import { auth, googleProvider, storeUser, getCurrentUser } from '../../firebase/firebase.utilities';
...
export function* getSnapshot(userAuth, data) {
    try {
        const userRef = yield call(storeUser, userAuth, data);
...
export function* userSagas() {
    yield all([call(onSignInGoogleStart), call(onSignInEmail), call(onCheckUserSession), call(onSignOutStart), call(onSignUpStart), call(onSignUpSuccess)]);
};